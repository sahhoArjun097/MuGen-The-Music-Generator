...
//    const moods = ["Cheerful", "Sorrow", "Uplifting", "Rock"];
...
//             {show && <p className="text-green-400 mt-4">Generating music for {selectedOption}...</p>}
//         </div>
...
// //               {/* <input type="file" accept="audio/*" onChange={handleFileChange} /> */}
// //               <button onClick={handleFileChange} className="border"> play

// //               </button>
// // <input type="button" onClick={handleFileChange}/>
// //               <canvas
// //                 ref={canvasRef}
